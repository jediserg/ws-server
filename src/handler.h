...
enum class HandlerPermission {ANYONE, USER, ADMIN};
...
struct RegisterHandler {
   RegisterHandler(const std::string &name, Handler handler, HandlerPermission permissions = HandlerPermission::ANYONE);
};
