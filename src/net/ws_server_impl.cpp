...
namespace ws
{
    ...
    WsServerImpl::WsServerImpl()
    {
        ...
        _server.set_open_handler(
                websocketpp::lib::bind(&WsServerImpl::_onWsOpen, this, websocketpp::lib::placeholders::_1));
        _server.set_close_handler(
                websocketpp::lib::bind(&WsServerImpl::_onWsClose, this, websocketpp::lib::placeholders::_1));
        _server.set_message_handler(
                websocketpp::lib::bind(&WsServerImpl::_onWsMessage, this, websocketpp::lib::placeholders::_1,
